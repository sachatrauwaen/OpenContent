...
namespace Satrabel.OpenContent
{
    public partial class Edit : PortalModuleBase
    {
        ...
        {
            base.OnInit(e);
            var bootstrap = App.Services.GlobalSettings(ModuleContext.PortalId).GetEditLayout() != AlpacaLayoutEnum.DNN;
            bool loadBootstrap = bootstrap && App.Services.GlobalSettings(ModuleContext.PortalId).GetLoadBootstrap();
            ...
            AlpacaContext.Horizontal = App.Services.GlobalSettings(ModuleContext.PortalId).GetEditLayout() == AlpacaLayoutEnum.BootstrapHorizontal;
