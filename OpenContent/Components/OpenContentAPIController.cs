    ...
    public class OpenContentAPIController : DnnApiController
    {
        ...
        public HttpResponseMessage Edit(string id)
        {
            try
            {
                ...
                context["bootstrap"] = App.Services.GlobalSettings(PortalSettings.PortalId).GetEditLayout() != AlpacaLayoutEnum.DNN;
                context["horizontal"] = App.Services.GlobalSettings(PortalSettings.PortalId).GetEditLayout() == AlpacaLayoutEnum.BootstrapHorizontal;
