    ...
    public class OpenContentAPIController : DnnApiController
    {
        ...
        public HttpResponseMessage Edit(string id)
        {
            try
            {
                ...
                context["bootstrap"] = App.Config.GlobalSettings.GetEditLayout() != AlpacaLayoutEnum.DNN;
                context["horizontal"] = App.Config.GlobalSettings.GetEditLayout() == AlpacaLayoutEnum.BootstrapHorizontal;
