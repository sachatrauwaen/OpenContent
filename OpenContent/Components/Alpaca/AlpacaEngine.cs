...
namespace Satrabel.OpenContent.Components.Alpaca
{
    public class AlpacaEngine
    {
        ...
        private void RegisterFields(bool bootstrap)
        {
            ...
            if (allFields || fieldTypes.ContainsAny("imagecropper", "imagecrop", "imagecrop2", "image"))
            {
            ...
            if (allFields || fieldTypes.ContainsAny("select2", "image2", "file2", "url2", "mlimage2", "mlfile2", "mlurl2", "mlfolder2", "imagecrop2", "role2", "user2", "image"))
            {
